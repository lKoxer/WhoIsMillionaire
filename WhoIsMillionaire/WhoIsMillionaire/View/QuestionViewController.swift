    ...
    extension QuestionViewController {
        func setupConstaint() {
            NSLayoutConstraint.activate ([
                ...
                logoView.topAnchor.constraint(equalTo: view.topAnchor, constant: 60),
